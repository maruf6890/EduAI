...
interface CardProps {
  ...
  description: string;
  className?: string;
  variant?: 'secondary' | 'primary' | 'purple' | 'accent' | 'rose';
  size?: 'sm' | 'md' | 'lg';
  glowEffect?: boolean;
  hoverScale?: number;
  interactive?: boolean;
...
//  --color-brand-primary: #3897a4;
// --color-brand-secondary: #8168f3;
// --color-brand-accent: #efe148;
...
export const VARIANTS = {
  ...
  primary: {
    accent: 'primary',
    gradient: 'from-brand-primary/20 to-brand-primary/0',
    shine:
